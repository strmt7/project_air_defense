...
- Do not invent licenses, asset provenance, screenshots, taps, or benchmark results.
- Update `android/assets/ATTRIBUTION.md` when importing external runtime assets.
