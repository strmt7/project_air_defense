...
object BattleWorldLayout {
    ...
    private val launcherPads = listOf(
    ...
    fun buildingMetrics(modelName: String): BuildingMetrics = when (modelName) {
    ...
    fun buildingDefinitions(): List<BattleBuildingDefinition> {
        ...
        fun addBuilding(modelName: String, x: Float, z: Float, yaw: Float = 0f) {
            ...
            definitions += BattleBuildingDefinition(
...
object RadarProjection {
    fun project(position: Vector3, radarX: Float, radarY: Float, radarWidth: Float, radarHeight: Float): RadarPlotPoint {
    ...
    fun launcherMarker(radarX: Float, radarY: Float, radarWidth: Float, radarHeight: Float): Vector2 {
        val markerY = radarY + radarHeight * 0.1f
        return Vector2(radarX + radarWidth * 0.5f, markerY)
    }

    fun sweepY(radarY: Float, radarHeight: Float, phase: Float): Float {
