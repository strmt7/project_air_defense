...
data class DefenseSettings(
    var engagementRange: Float = 2700f,
    var interceptorSpeed: Float = 660f,
    var launchCooldown: Float = 0.3f,
    var blastRadius: Float = 78f
)
...
class BattleSimulation(
    ...
    private val defenseOrigin = if (launcherPads.isEmpty()) {
    ...
    val buildings = buildingDefinitions.map {
        SimulationBuilding(
            id = it.id,
    ...
    fun step(dt: Float): BattleStepEvents {
        ...
        while (interceptorIterator.hasNext()) {
            ...
            val aimPoint = InterceptionMath.predictInterceptPoint(
    ...
    fun snapshot(runIndex: Int, simulatedSeconds: Float): BattleRunSummary = BattleRunSummary(
        runIndex = runIndex,
    ...
    private fun selectNextThreat(): SimulationThreat? {
        ...
        val selected = FireControl.selectNextThreat(
    ...
    private fun launchInterceptor(target: SimulationThreat): InterceptorLaunchEvent {
        val launcherIndex = launcherPads.indices.minByOrNull { index ->
        ...
        val interceptor = SimulationInterceptor(
