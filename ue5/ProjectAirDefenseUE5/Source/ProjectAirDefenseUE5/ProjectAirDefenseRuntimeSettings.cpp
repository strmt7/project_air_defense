...
UProjectAirDefenseRuntimeSettings::UProjectAirDefenseRuntimeSettings() {
  ...
  this->DirectionalLightIntensityLux = 65000.0;
  this->SkyLightIntensityScale = 1.35;
  ...
  this->FogDensity = 0.00055f;
  this->FogHeightFalloff = 0.16f;
  this->FogMaxOpacity = 0.42f;
  this->FogStartDistanceMeters = 2600.0f;
  ...
  this->PostBloomIntensity = 0.12f;
  this->PostVignetteIntensity = 0.14f;
  this->PostSaturation = 1.02f;
  this->PostContrast = 1.00f;
  this->CameraFieldOfViewDegrees = 36.0f;
  this->CameraDefaultDistanceMeters = 5200.0f;
  ...
  this->CameraFramedDistanceMultiplier = 1.85f;
  this->CameraFocusVerticalOffsetRatio = 0.03f;
