...
4. Build an installable APK:
   - Preferred helper script: `./scripts/build-installable-apk.sh`
   - Local side-load build: `./gradlew :android:assembleLocal`
   - Production/update-safe build: `./gradlew :android:printAppIdentity :android:printReleaseSigningSource :android:assembleRelease`
