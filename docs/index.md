...
- `sima-inspired-benchmarks.md` -- short-horizon benchmark/task framing for gameplay evaluation
...
- `reference/android-visual-qa-sources.md` -- detailed source list for Android visual QA tooling
