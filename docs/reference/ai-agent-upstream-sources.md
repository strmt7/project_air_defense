...
| --- | --- | --- |
| Karpathy baseline: `forrestchang/andrej-karpathy-skills` `2c606141936f1eeef17fa3043a72095b4765b9c2` | agent-neutral behavioral baseline: think before coding, simplicity first, surgical changes, and goal-driven execution. Upstream `EXAMPLES.md` is optional rationale only, not default context. | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md` |
...
| Epic UI/mobile docs, `quodsoler/unreal-engine-skills`, `winyunq/UnrealMotionGraphicsMCP`, and selected Epic forum touch-input threads | UE5 smartphone UI, mobile rendering settings, and agent-skill structure for touch-first work | `docs/reference/ue5-mobile-agent-skill-sources.md`, `.agents/skills/ue5-mobile-ui/SKILL.md`, `.agents/skills/ue5-mobile-rendering/SKILL.md` |
| 50+ public Android/3D game, renderer, physics, GIS, asset-pipeline, automation, and Unreal workflow repositories | implementation priorities for UE5 mobile game production, graphics proof, headless simulation, and city-source validation | `docs/reference/android-3d-game-repo-benchmark.md`, `docs/benchmark-suite.md`, `docs/architecture.md` |
